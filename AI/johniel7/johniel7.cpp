...
class Johniel7 : public Solver {
public:
  Johniel7(const Model& src_, const Model& dst_, std::ofstream& ofs)
...
void Johniel7::getClose(Squad& s, vector<Point> ps)
{
  while (s[0].pos != ps[0]) {
...
Johniel7::Squad Johniel7::newSquad(Bot a)
{
...
bool Johniel7::assemblePlaneY(Squad& squad, PlaneY p)
{
...
bool Johniel7::assembleWithPlanes(const int y, Squad& squad)
{
  cout << "Y:=" << y << endl;
  cout << "bots:"; each (s, squad) cout << s.pos ; cout << endl;
...
void Johniel7::distribute(Squad& s)
{
...
void Johniel7::finalize(Squad& s)
{
