...
class Johniel5 : public Solver {
public:
  Johniel5(const Model& src_, const Model& dst_, std::ofstream& ofs)
...
void Johniel5::getClose(Squad& s, vector<Point> ps)
{
  while (s[0].pos != ps[0]) {
...
Johniel5::Squad Johniel5::newSquad(Bot a)
{
...
bool Johniel5::assemblePlaneY(Squad& squad, PlaneY p)
{
...
bool Johniel5::assembleWithPlanes(const int y, Squad& squad)
{
  cout << "Y:=" << y << endl;
  cout << "bots:"; each (s, squad) cout << s.pos ; cout << endl;
...
void Johniel5::distribute(Squad& s)
{
...
void Johniel5::finalize(Squad& s)
{
