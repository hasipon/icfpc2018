...
class Johniel8 : public Solver {
public:
  Johniel8(const Model& src_, const Model& dst_, std::ofstream& ofs)
...
Johniel8::Squad Johniel8::newSquad(Bot a)
{
...
bool Johniel8::assemblePlaneY(Squad& squad, PlaneY p)
{
...
bool Johniel8::assembleWithPlanes(const int y, Squad& squad)
{
  cout << "Y:=" << y << endl;
  cout << "bots:"; each (s, squad) cout << s.pos ; cout << endl;
...
void Johniel8::distribute(Squad& s)
{
...
void Johniel8::finalize(Squad& s)
{
